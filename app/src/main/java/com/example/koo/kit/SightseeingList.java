...
public class SightseeingList extends Fragment {
    ...
    public final static String ITEMS_COUNT_KEY = "SightseeingList$ItemsCount";

    public static SightseeingList createInstance(int itemsCount) {
        SightseeingList SightseeingList = new SightseeingList();
        Bundle bundle = new Bundle();
        bundle.putInt(ITEMS_COUNT_KEY, itemsCount);
        SightseeingList.setArguments(bundle);
...
/* *********************************************************************************************************************************** */
    ...
    public class StoreAsyncTask extends AsyncTask<String,Integer,String> {
        ...
        private String recvList() { //데이터 보내고 받아오기!!
            ...
            prop.setProperty("businessType", "3"); // 관광지 Type = 3

...
public class AccomodationList extends Fragment{
    ...
    public final static String ITEMS_COUNT_KEY = "AccomodationList$ItemsCount";

    public static AccomodationList createInstance(int itemsCount) {
        AccomodationList AccomodationList = new AccomodationList();
        Bundle bundle = new Bundle();
        bundle.putInt(ITEMS_COUNT_KEY, itemsCount);
        AccomodationList.setArguments(bundle);
